// Base URL for the backend API (works both locally and behind a proxy)
...
async function populateModelDropdown() {
    ...
    try {
        ...
        // Preserve the first auto-route option
        ...
        models.forEach(m => {
            ...
            opt.value = m.id;
            opt.textContent = `${shortId} (${m.tier || "standard"})`;
